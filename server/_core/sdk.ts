...
class SDKServer {
  ...
  private getSessionSecret() {
    ...
    if (!secret) {
      throw new Error("JWT_SECRET is not configured. Set JWT_SECRET in your environment before starting the server.");
    }
  ...
  async verifySession(
    ...
    try {
      ...
      // openId and appId are required for auth; name is cosmetic and may be empty for older accounts
