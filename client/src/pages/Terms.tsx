      ...
      <div className="max-w-3xl mx-auto px-4 py-10 prose prose-slate">
        ...
        <div className="space-y-6 text-foreground text-sm leading-relaxed">
          <section>
            ...
            <p>By accessing or using ProposalCraft AI ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold mb-2">2. Description of Service</h2>
            <p>ProposalCraft AI is a software-as-a-service (SaaS) platform that enables trade contractors — including HVAC technicians, plumbers, electricians, and roofers — to generate professional job proposals using artificial intelligence. The Service includes AI-powered proposal generation, PDF export, email delivery, and proposal tracking features.</p>
          </section>
          ...
          <section>
            ...
            <p>Proposals generated by the Service are produced by artificial intelligence and are provided as a starting point. You are solely responsible for reviewing, editing, and verifying all AI-generated content before sending it to clients. ProposalCraft AI makes no warranty that generated proposals are accurate, complete, or suitable for any specific job or jurisdiction.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold mb-2">7. Intellectual Property</h2>
            <p>You retain ownership of all content you input into the Service and all proposals you generate. By using the Service, you grant ProposalCraft AI a limited license to process your inputs solely for the purpose of providing the Service.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold mb-2">8. Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, ProposalCraft AI shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Service. Our total liability to you for any claim shall not exceed the amount you paid us in the 12 months preceding the claim.</p>
          </section>
